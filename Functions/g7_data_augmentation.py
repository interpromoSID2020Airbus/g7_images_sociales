...
def create_windows_one_img(shape: tuple, img: PIL.Image, nb_win: int, greys: bool) -> list:
    ...
    Out:
        arrs_crop: arrays (representing images).
...
def data_augmentation(train_path: str, shape: tuple, save_format: str='jpeg', nb_win: int=3,
    ...
    1- If the image is rectangular,
    2- Perform data augmentation on these cropped images, with a keras ImageDataGenerator.
    ...
    # Get classes from train directory, e.g. ['Airbus', 'Boeing'], or ['A320', 'A330']
    classes = os.listdir(train_path)
    
    # Define keras ImageDataGenerator 
    ...
    for class_ in classes:
        ...
        for k in range(len(imgs_names)):
            ...
            # Get the image, and crop it with sliding windows
            ...
            # For each new image, perform data augmentation and save to directory
